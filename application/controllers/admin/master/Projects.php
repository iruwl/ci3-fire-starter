...
class Projects extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        define('THIS_URL', base_url('admin/master/projects'));
    ...
    public function index()
    {
        ...
        // load views
        $data['content'] = $this->load->view('admin/master/projects/list', $content_data, true);
    ...
    public function add()
    {
        ...
        // load views
        $data['content'] = $this->load->view('admin/master/projects/form', $content_data, true);
        $this->load->view($this->template, $data);
    }
