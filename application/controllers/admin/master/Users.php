...
class Users extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        define('THIS_URL', base_url('admin/master/users'));
    ...
    public function index()
    {
        ...
        // load views
        $data['content'] = $this->load->view('admin/master/users/list', $content_data, true);
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($saved) {
                $this->session->set_flashdata('message', sprintf(lang('users msg add_user_success'), $this->input->post('name')));
            } else {
                $this->session->set_flashdata('error', sprintf(lang('users error add_user_failed'), $this->input->post('name')));
            }
        ...
        // load views
        $data['content'] = $this->load->view('admin/master/users/form', $content_data, true);
        $this->load->view($this->template, $data);
    }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($saved) {
                $this->session->set_flashdata('message', sprintf(lang('users msg edit_user_success'), $this->input->post('name')));
            } else {
                $this->session->set_flashdata('error', sprintf(lang('users error edit_user_failed'), $this->input->post('name')));
            }
    ...
    public function delete($id = null)
    {
        ...
        if (!is_null($id) or !is_numeric($id)) {
            ...
            if ($user) {
                ...
                if ($delete) {
                    $this->session->set_flashdata('message', sprintf(lang('users msg delete_user'), $user['name']));
                } else {
                    $this->session->set_flashdata('error', sprintf(lang('users error delete_user'), $user['name']));
                }
            } else {
     ...
     * @return int|boolean
     */
    public function _check_username($username, $current)
    {
