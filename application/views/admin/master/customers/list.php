    ...
    <table class="table table-condensed table-hover" style="margin-bottom: unset;">
        <thead>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo current_url(); ?>?sort=nama&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('customers col nama'); ?></a>
                    <?php if ($sort == 'nama'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=alamat&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('customers col alamat'); ?></a>
                    <?php if ($sort == 'alamat'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=status&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('customers col status'); ?></a>
                    <?php if ($sort == 'status'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=keterangan&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('customers col keterangan'); ?></a>
                    <?php if ($sort == 'keterangan'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td class="pull-right">
                ...
                <tr>
                    <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role' => 'form', 'id' => "filters")); ?>
                        ...
                        <td<?php echo ((isset($filters['nama'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'nama', 'id' => 'nama', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('customers input nama'), 'value' => set_value('nama', ((isset($filters['nama'])) ? $filters['nama'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['alamat'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'alamat', 'id' => 'alamat', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('customers input alamat'), 'value' => set_value('alamat', ((isset($filters['alamat'])) ? $filters['alamat'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['status'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'status', 'id' => 'status', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('customers input status'), 'value' => set_value('status', ((isset($filters['status'])) ? $filters['status'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['keterangan'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'keterangan', 'id' => 'keterangan', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('customers input keterangan'), 'value' => set_value('keterangan', ((isset($filters['keterangan'])) ? $filters['keterangan'] : '')))); ?>
                        </td>
                        <td colspan="3">
            ...
            <?php $i = 1;if ($dt_total): ?>
                <?php foreach ($dt_rows as $row): ?>
                    <tr>
                        ...
                        <td<?php echo (($sort == 'alamat') ? ' class="sorted"' : ''); ?>>
                            <?php echo $row['alamat']; ?>
                        </td>
                        <td<?php echo (($sort == 'status') ? ' class="sorted"' : ''); ?>>
                            <?php echo $row['status']; ?>
                        </td>
                        <td<?php echo (($sort == 'keterangan') ? ' class="sorted"' : ''); ?>>
