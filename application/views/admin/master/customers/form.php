    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group <?php echo form_error('nama') ? ' has-error' : ''; ?>">
                <?php echo form_label(lang('customers input nama'), 'nama', array('class' => 'control-label')); ?>
            ...
            <div class="form-group <?php echo form_error('alamat') ? ' has-error' : ''; ?>">
                <?php echo form_label(lang('customers input alamat'), 'alamat', array('class' => 'control-label')); ?>
                <span class="required">*</span>
                <?php echo form_input(array('name' => 'alamat', 'value' => set_value('alamat', (isset($dt['alamat']) ? $dt['alamat'] : '')), 'class' => 'form-control')); ?>
            </div>
            <div class="form-group <?php echo form_error('status') ? ' has-error' : ''; ?>">
                <?php echo form_label(lang('customers input status'), 'status', array('class' => 'control-label')); ?>
                <span class="required">*</span>
                <?php echo form_dropdown('status', $dt_status, (isset($dt['status']) ? $dt['status'] : 'Undefined'), 'id="status" class="form-control"'); ?>
            </div>
            <div class="form-group <?php echo form_error('keterangan') ? ' has-error' : ''; ?>">
                <?php echo form_label(lang('customers input keterangan'), 'keterangan', array('class' => 'control-label')); ?>
                <span class="required">*</span>
