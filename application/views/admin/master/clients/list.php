    ...
    <table class="table table-condensed table-hover" style="margin-bottom: unset;">
        <thead>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo current_url(); ?>?sort=nama&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('clients col nama'); ?></a>
                    <?php if ($sort == 'nama'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=alamat&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('clients col alamat'); ?></a>
                    <?php if ($sort == 'alamat'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=kategori&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('clients col kategori'); ?></a>
                    <?php if ($sort == 'kategori'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=status&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('clients col status'); ?></a>
                ...
                <tr>
                    <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role' => 'form', 'id' => "filters")); ?>
                        ...
                        <td<?php echo ((isset($filters['nama'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'nama', 'id' => 'nama', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('clients input nama'), 'value' => set_value('nama', ((isset($filters['nama'])) ? $filters['nama'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['alamat'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'alamat', 'id' => 'alamat', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('clients input alamat'), 'value' => set_value('alamat', ((isset($filters['alamat'])) ? $filters['alamat'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['kategori'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'kategori', 'id' => 'kategori', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('clients input kategori'), 'value' => set_value('kategori', ((isset($filters['kategori'])) ? $filters['kategori'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['status'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'status', 'id' => 'status', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('clients input status'), 'value' => set_value('status', ((isset($filters['status'])) ? $filters['status'] : '')))); ?>
                        </td>
                        <td colspan="3">
