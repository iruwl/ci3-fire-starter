    ...
    <table class="table table-condensed table-hover" style="margin-bottom: unset;">
        <thead>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo current_url(); ?>?sort=nama&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('contacts col nama'); ?></a>
                    <?php if ($sort == 'nama'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=jabatan&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('contacts col jabatan'); ?></a>
                    <?php if ($sort == 'jabatan'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=hp1&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('contacts col hp1'); ?></a>
                    <?php if ($sort == 'hp1'): ?><span class="glyphicon glyphicon-arrow-<?php echo (($dir == 'asc') ? 'up' : 'down'); ?>"></span><?php endif;?>
                </td>
                <td>
                    <a href="<?php echo current_url(); ?>?sort=email&dir=<?php echo (($dir == 'asc') ? 'desc' : 'asc'); ?>&limit=<?php echo $limit; ?>&offset=<?php echo $offset; ?><?php echo $filter; ?>"><?php echo lang('contacts col email'); ?></a>
                ...
                <tr>
                    <?php echo form_open("{$this_url}?sort={$sort}&dir={$dir}&limit={$limit}&offset=0{$filter}", array('role' => 'form', 'id' => "filters")); ?>
                        ...
                        <td<?php echo ((isset($filters['nama'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'nama', 'id' => 'nama', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('contacts input nama'), 'value' => set_value('nama', ((isset($filters['nama'])) ? $filters['nama'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['jabatan'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'jabatan', 'id' => 'jabatan', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('contacts input jabatan'), 'value' => set_value('jabatan', ((isset($filters['jabatan'])) ? $filters['jabatan'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['hp1'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'hp1', 'id' => 'hp1', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('contacts input hp1'), 'value' => set_value('hp1', ((isset($filters['hp1'])) ? $filters['hp1'] : '')))); ?>
                        </td>
                        <td<?php echo ((isset($filters['email'])) ? ' class="has-success"' : ''); ?>>
                            <?php echo form_input(array('name' => 'email', 'id' => 'email', 'style' => 'height: unset; padding: 3px 3px; border-radius: 2px;', 'class' => 'form-control', 'placeholder' => lang('contacts input email'), 'value' => set_value('email', ((isset($filters['email'])) ? $filters['email'] : '')))); ?>
                        </td>
                        <td colspan="3">
            ...
            <?php $i = 1;if ($dt_total): ?>
                <?php foreach ($dt_rows as $row): ?>
                    <tr>
                        ...
                        <td<?php echo (($sort == 'jabatan') ? ' class="sorted"' : ''); ?>>
                            <?php echo $row['jabatan']; ?>
                        </td>
                        <td<?php echo (($sort == 'hp1') ? ' class="sorted"' : ''); ?>>
                            <?php echo $row['hp1']; ?>
                        </td>
